      ...
      <View style={styles.container}>
        ...
        <View style={styles.setupContainer}>
          ...
          <View style={styles.stepsContainer}>
            ...
            <Text style={[styles.stepTitle, { marginTop: spacing.md }]}>2. Open Termux, paste this:</Text>
            <View style={styles.codeBlock}>
              <Text style={styles.codeText} selectable>pkg install python git ripgrep -y{'\n'}pip install git+https://github.com/UIoperationParamters29/PocketAgent.git@main#subdirectory=runtime-pkg{'\n'}pocketagent-start</Text>
            </View>
            <Text style={styles.stepHint}>↑ Long-press to copy, then paste in Termux</Text>

            <Text style={[styles.stepTitle, { marginTop: spacing.md }]}>3. When you see "✅ PocketAgent is running"</Text>
            <Text style={styles.stepDesc}>Come back here and tap "Check again".</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  stepHint: { color: colors.textTertiary, fontFamily: typography.mono, fontSize: 10, marginTop: spacing.xs, marginBottom: spacing.sm },
